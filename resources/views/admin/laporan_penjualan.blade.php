          ...
          <div class="box">
            <div class="box-header">
              <ul class="nav nav-tabs-custom">
                <li class="pull-left box-header"><h3 class="box-title">Laporan Penjualan</h3></li>
              </ul>
            </div>
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            $.each(data, function(k, v) {
              ...
              $("#penjualan").append("<tr><td align='center'>"+nomorBaris+"</td><td>"+v.kode_penjualan+"</td><td>"+v.tgl+"</td><td>"+v.total+"</td></tr>");
            });

            $("#cetak").attr("href", "{{url('manager/laporan/printpenjualan')}}/"+tgl_a+'/'+tgl_b).attr('target','_blank');;
          }
        })
      })
    })
