...
@section("title", "Manager | Ubah Data Penjualan")
                    ...
                    <tbody id="type_container">
                      ...
                      @foreach($data->detail_jual as $detail_jual)
                        ...
                        <tr id="tr{{$id}}">
                          ...
                          <td class="col-md-3 control-label"><a class="remove-type" targetDiv="" data-id="tr{{$no}}" href="javascript: void(0)"><i class="glyphicon glyphicon-trash"></i></a></td>
                        </tr>
                      @endforeach
                    </tbody>
                  </table>
      ...
      $('#submit').on('click', function(){
        if(Validate()){
          ...
          function a(){
            ...
            $.ajax({
                type: "GET",
                url: "/dynasti/public/manager/penjualan/ubah/"+idjual+"/"+pengguna+"/"+datepicker+"/"+total,
                success: function(result) {
