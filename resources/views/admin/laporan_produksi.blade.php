...
@section("title", "Manager | Laporan Produksi")

@section("lappro", "active")
          ...
          <div class="box">
            <div class="box-header">
              <ul class="nav nav-tabs-custom">
                <li class="pull-left box-header"><h3 class="box-title">Laporan Produksi</h3></li>
              </ul>
            </div>
              ...
              <table id="example1" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <th style="width: 210px">Kode Produksi</th>
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            $.each(data, function(k, v) {
              ...
              $("#produksi").append("<tr><td align='center'>"+nomorBaris+"</td><td>"+v.kode_produksi+"</td><td>"+v.tgl+"</td></tr>");
            });

            $("#cetak").attr("href", "{{url('manager/laporan/printproduksi')}}/"+tgl_a+'/'+tgl_b).attr('target','_blank');;
          }
        })
      })
    })
