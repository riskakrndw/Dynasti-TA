...
@section("title", "Manager | Ubah Data Produksi")
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="text" class="form-control pull-right" id="datepicker" name="datepicker" value="{{ $data->tgl }}" placeholder="Tanggal Produksi" data-date-end-date="0d">
                        </div>
