...
@section("title", "Manager | Tambah Data Pemesanan")
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="input-group date">
                          ...
                          <input type="text" class="form-control pull-right" id="datepicker" placeholder="Tanggal Pemesanan" name="tanggal" data-date-start-date="0d">
                        </div>
