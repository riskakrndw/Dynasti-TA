        ...
        <table align="center" style="width:100%;border-collapse: collapse; margin-top:10px; " id="dataTables-example" border="1">
            <thead>
                <tr style="font-size:18px; height:50px;">
                    ...
                    <th class = "row" style="width: 180px; background-color:#bdc3c7;" colspan="4">Daftar Bahan Baku</th>
                </tr>
            </thead>
            <tbody>
                <?php $no=1; ?>
                @foreach($data as $q=>$v)
                    <tr>
                        ...
                        <th class = "row" style="width: 100px; background-color:#ecf0f1;">Nama</th>
                ...
                <tr style="font-size:18px; height:30px;">
                    ...
                    <td>Rp {{ number_format($totalpengadaan,2,",","." ) }}</td>
                </tr>
            </tbody>
        </table>
