                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 100%;" name="listJenis" id="listJenis">
                          <option disabled="disabled" selected="selected" value="0">Pilih Jenis</option>
                      ...
                      <div class="form-group">
                        <label>Harga</label>
                          <div class="input-group">
                            ...
                            <input class="form-control" placeholder="Harga" name="harga" id="harga" onKeyPress="return goodchars(event,'0123456789',this)">
                          </div>
                          @if($errors->has('harga'))
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" style="width: 100%;" name="listRasa" id="listRasa">
                          <option disabled="disabled" selected="selected" value="0">Pilih Rasa</option>
                          @foreach($dataRasa as $dataRasa)
                          <option value="{{ $dataRasa->id }}">{{ $dataRasa->nama }}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="form-group">
                        <label>Stok</label>
                          <div class="input-group">
                            ...
                            <input class="form-control" placeholder="Stok" name="stok" id="stok" onKeyPress="return goodchars(event,'0123456789',this)">
                          </div>
                          @if($errors->has('stok'))
